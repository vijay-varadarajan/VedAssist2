...
downloads_dir = os.path.join("", "C:/Users/vijay/Documents/Vedassist/core/vedassist/ml_model/model.pkl")
classifier = joblib.load(downloads_dir)

# Save the model
joblib.dump(classifier, downloads_dir)
...
def main():
        user_input = "0,1,1,0,1,0,0,0,0,0,0,1,1,50"
